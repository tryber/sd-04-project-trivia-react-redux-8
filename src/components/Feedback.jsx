...
const Feedback = (props) => {
  ...
  return (
    <div>
      <div>
        <p className="plyer-name" data-testid="header-player-name">`Jogador ${nome}`</p>
        <p className="pontos" data-testid="header-score">`Pontos ${score}`</p>
      </div>
      <img src="http://www.abrhce.com.br/wp-content/uploads/2017/03/feedback.jpg" className="feedbackGravatar" data-testid="header-profile-picture" />
